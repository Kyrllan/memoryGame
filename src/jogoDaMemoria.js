class JogoDaMemoria {
  constructor({ tela, util }) {
    ...
    this.heroisIniciais = [
      { img: "./assets/america.png", nome: "america" },
      { img: "./assets/arrow.png", nome: "arrow" },
      { img: "./assets/blackwidow.png", nome: "blackwidow" },
      { img: "./assets/deadpool.png", nome: "deadpool" },
      { img: "./assets/hulk.png", nome: "hulk" },
      { img: "./assets/ironman.png", nome: "ironman" },
      { img: "./assets/loki.png", nome: "loki" },
      { img: "./assets/panther.png", nome: "panther" },
      { img: "./assets/spider.png", nome: "spider" },
      { img: "./assets/thanos.png", nome: "thanos" },
    ];
